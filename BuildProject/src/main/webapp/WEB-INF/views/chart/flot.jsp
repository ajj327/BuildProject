...
<body>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="panelsWells.jsp">Panels and Wells</a>
                                </li>
                                <li>
    ...
    <script src="resources/bower_components/flot/excanvas.min.js"></script>
    ...
    <script src="resources/bower_components/flot/jquery.flot.time.js"></script>
    <script src="resources/bower_components/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
