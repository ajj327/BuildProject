...
<head>
    ...
    <script src="Myresources/scripts/jquery-1.11.1.min.js"></script>
    <script src="Myresources/jqwidgets/jqxcore.js"></script>
    <script src="Myresources/jqwidgets/jqxtooltip.js"></script>
    <script src="Myresources/jqwidgets/jqxtreemap.js"></script>
    <script type="text/javascript" src="Myresources/scripts/demos.js"></script>
    <link rel="stylesheet" href="Myresources/jqwidgets/styles/jqx.base.css" />
    <script>
        $(function () {
            var data = [
            {
